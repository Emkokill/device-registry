...
import { SECTIONS, SECTION_BODIES, DEFINITIONS, TERM_LABELS, SECTION_TITLES } from "@/lib/content";
...
function DefinedTerm({ term }) {
  const { lang } = useLang();
  const t = useT();
  const def = DEFINITIONS[lang]?.[term] || DEFINITIONS.ru[term];
  const label = TERM_LABELS[lang]?.[term] || term;
  return (
...
export default function DocumentPage() {
  ...
  const titles = SECTION_TITLES[lang] || SECTION_TITLES.ru;
  const bodies = SECTION_BODIES[lang] || SECTION_BODIES.ru;
    ...
    <div data-testid="document-page">
      ...
      <section className="max-w-7xl mx-auto px-5 lg:px-8 py-12 lg:py-16">
        <div className="grid lg:grid-cols-12 gap-10">
          <aside className="hidden lg:block lg:col-span-3" data-testid="document-sidebar">
          ...
          <article className="lg:col-span-9 space-y-16" data-testid="document-content">
              ...
              return (
                ...
                >
                      ...
                      {body.terms.map((term) => (
                        ...
                        >
                          ...
                          <p className="text-sm text-[#475569] mt-2 leading-relaxed">
                            {DEFINITIONS[lang]?.[term] || DEFINITIONS.ru[term]}
                          </p>
                        </div>
                      ))}
                    </div>
                  ...
                  {s.id === "otvetstvennost" && (
                    ...
                    >
                      <p className="text-sm font-semibold text-[#991B1B]">{t("doc.warning")}</p>
            ...
            <div className="border-t border-[#E2E8F0] pt-10">
              ...
              >
                {t("doc.end_cta")} <ArrowRight size={15} />
              </Link>
            </div>
          </article>
        </div>
